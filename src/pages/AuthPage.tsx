...
const AuthPage = () => {
  ...
  const { user, profile, loading: authLoading, isAuthenticated, hasRole, signOut, signIn, signInWithOAuth, signUp } = useAuth();
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'facebook') => {
    ...
    try {
      ...
      if (error) {
        toast({
          title: t('oauth_error'),
          description: error.message || t('oauth_connection_failed'),
          variant: "destructive"
        });
      }
    } catch (error: any) {
                  ...
                  <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-white text-gray-500">{t('oauth_separator')}</span>
                      </div>
                    </div>
