  ...
  try {
    ...
    switch (email_action_type) {
      ...
      case "magiclink":
        ...
        confirmationUrl = `${baseUrl}/auth/v1/verify?token=${token_hash}&type=${email_action_type}&redirect_to=${encodeURIComponent(CIARA_DOMAIN + "/auth/callback")}&apikey=${supabaseAnonKey}`;
        functionData = {
          email: user.email,
