...
-- Company description
('footer_company_description', 'fr', 'Découvrez les destinations avec notre plateforme de tourisme gamifié.', 'footer', 'Footer company description'),
('footer_company_description', 'en', 'Discover destinations with our gamified tourism platform.', 'footer', 'Footer company description'),
('footer_company_description', 'de', 'Entdecken Sie Reiseziele mit unserer gamifizierten Tourismusplattform.', 'footer', 'Footer company description'),
