-- CIARA Content Improvement Plan Implementation (Corrected)
...
-- Phase 5: Create structured thematic journeys (without type_id)
-- Heritage Journey for Carcassonne
INSERT INTO public.journeys (city_id, category_id, name, description, difficulty, estimated_duration, total_points, is_active, is_predefined)
SELECT 
  c.id,
  cat.id,
