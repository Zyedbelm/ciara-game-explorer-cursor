...
-- Simplify user roles by first dropping function, then updating enum
DROP FUNCTION IF EXISTS public.update_user_role(text, user_role);
...
-- Recreate the update_user_role function with simplified roles
