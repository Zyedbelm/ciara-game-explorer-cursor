...
BEGIN
    ...
    -- Insert journey categories for each city (with unique slugs)
    ...
    -- Sète categories
    (sete_patrimoine_id, sete_id, 'Patrimoine Maritime', 'sete-patrimoine-maritime', 'Découvrez l''héritage maritime de Sète', 'patrimoine-culturel', 'easy', 120, 'anchor', '#1E40AF'),
    (sete_gastro_id, sete_id, 'Gastronomie Sétoise', 'sete-gastronomie', 'Savourez les spécialités de la mer', 'gastronomie-locale', 'easy', 90, 'utensils', '#DC2626'),
    (sete_nature_id, sete_id, 'Canaux et Nature', 'sete-canaux-nature', 'Explorez les canaux et espaces naturels', 'randonnees-nature', 'medium', 150, 'waves', '#059669'),
    (sete_ville_id, sete_id, 'Centre Historique', 'sete-centre-historique', 'Promenade dans le vieux Sète', 'vieille-ville', 'easy', 60, 'building', '#7C3AED'),
    (sete_art_id, sete_id, 'Art et Culture', 'sete-art-culture', 'Musées et sites culturels sétois', 'art-culture', 'easy', 90, 'palette', '#F59E0B'),
    
    -- Narbonne categories
    (narbonne_patrimoine_id, narbonne_id, 'Patrimoine Romain', 'narbonne-patrimoine-romain', 'Sur les traces de la Rome antique', 'patrimoine-culturel', 'easy', 120, 'landmark', '#8B4513'),
    (narbonne_gastro_id, narbonne_id, 'Gastronomie Narbonnaise', 'narbonne-gastronomie', 'Découvrez les saveurs du terroir', 'gastronomie-locale', 'easy', 90, 'utensils', '#DC2626'),
    (narbonne_nature_id, narbonne_id, 'Nature et Vignobles', 'narbonne-nature-vignobles', 'Entre nature et vignes', 'randonnees-nature', 'medium', 180, 'grape', '#059669'),
    (narbonne_ville_id, narbonne_id, 'Centre Médiéval', 'narbonne-centre-medieval', 'Le cœur historique de Narbonne', 'vieille-ville', 'easy', 75, 'building', '#7C3AED'),
    (narbonne_art_id, narbonne_id, 'Arts et Musées', 'narbonne-arts-musees', 'Richesses culturelles narbonnaises', 'art-culture', 'easy', 90, 'palette', '#F59E0B'),
    
    -- Collioure categories  
    (collioure_patrimoine_id, collioure_id, 'Patrimoine Royal', 'collioure-patrimoine-royal', 'Château et fortifications', 'patrimoine-culturel', 'easy', 90, 'castle', '#8B4513'),
    (collioure_gastro_id, collioure_id, 'Gastronomie Catalane', 'collioure-gastronomie-catalane', 'Saveurs de Catalogne', 'gastronomie-locale', 'easy', 75, 'utensils', '#DC2626'),
    (collioure_nature_id, collioure_id, 'Côte Vermeille', 'collioure-cote-vermeille', 'Criques et sentiers côtiers', 'randonnees-nature', 'medium', 120, 'mountain', '#059669'),
    (collioure_ville_id, collioure_id, 'Village de Pêcheurs', 'collioure-village-pecheurs', 'Le charme de Collioure', 'vieille-ville', 'easy', 45, 'building', '#7C3AED'),
    (collioure_art_id, collioure_id, 'Art et Fauvisme', 'collioure-art-fauvisme', 'Sur les pas des peintres', 'art-culture', 'easy', 60, 'palette', '#F59E0B'),
    
    -- Gruissan categories
    (gruissan_patrimoine_id, gruissan_id, 'Patrimoine Salicole', 'gruissan-patrimoine-salicole', 'L''héritage des sauniers', 'patrimoine-culturel', 'easy', 90, 'droplets', '#8B4513'),
    (gruissan_gastro_id, gruissan_id, 'Gastronomie Lagunaire', 'gruissan-gastronomie-lagunaire', 'Produits de l''étang', 'gastronomie-locale', 'easy', 75, 'utensils', '#DC2626'),
    (gruissan_nature_id, gruissan_id, 'Étangs et Flamants', 'gruissan-etangs-flamants', 'Faune et flore lagunaires', 'randonnees-nature', 'easy', 120, 'bird', '#059669'),
    (gruissan_ville_id, gruissan_id, 'Village Circulaire', 'gruissan-village-circulaire', 'L''unique village rond', 'vieille-ville', 'easy', 45, 'building', '#7C3AED'),
    (gruissan_art_id, gruissan_id, 'Culture Maritime', 'gruissan-culture-maritime', 'Traditions et savoir-faire', 'art-culture', 'easy', 60, 'palette', '#F59E0B'),
    
    -- Carcassonne categories
    (carcassonne_patrimoine_id, carcassonne_id, 'Cité Médiévale', 'carcassonne-cite-medievale', 'La forteresse du Moyen Âge', 'patrimoine-culturel', 'easy', 150, 'shield', '#8B4513'),
    (carcassonne_gastro_id, carcassonne_id, 'Gastronomie Audoise', 'carcassonne-gastronomie-audoise', 'Spécialités du pays cathare', 'gastronomie-locale', 'easy', 90, 'utensils', '#DC2626'),
    (carcassonne_nature_id, carcassonne_id, 'Canal du Midi', 'carcassonne-canal-midi', 'Patrimoine mondial UNESCO', 'randonnees-nature', 'easy', 120, 'waves', '#059669'),
    (carcassonne_ville_id, carcassonne_id, 'Bastide Saint-Louis', 'carcassonne-bastide-saint-louis', 'La ville basse médiévale', 'vieille-ville', 'easy', 75, 'building', '#7C3AED'),
    (carcassonne_art_id, carcassonne_id, 'Art et Histoire', 'carcassonne-art-histoire', 'Musées et patrimoine', 'art-culture', 'easy', 90, 'palette', '#F59E0B');
    ...
    RAISE NOTICE 'Plan implementation completed: 5 new French cities created with complete journey data, Swiss cities updated with hero images.';
END $$;