-- ============================================
-- MIGRATION COMPLÈTE : SION + ENRICHISSEMENT TOUTES VILLES
-- ============================================
...
SELECT 
  ...
  'patrimoine-culturel'::journey_type,
...
SELECT 
  ...
  'gastronomie-locale'::journey_type,
  'easy'::journey_difficulty,
  90,
  'utensils',
  '#DC2626'
...
SELECT 
  ...
  'randonnees-nature'::journey_type,
