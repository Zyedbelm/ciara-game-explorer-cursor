-- Audit et correction du système de points (version corrigée)

-- Étape 1: Supprimer temporairement le trigger d'audit sur step_completions
DROP TRIGGER IF EXISTS audit_trigger ON step_completions;

-- Étape 2: Supprimer les anciens triggers défaillants
...
-- Étape 5: Créer une fonction pour la suppression de step_completions
...
-- Étape 6: Créer les nouveaux triggers
