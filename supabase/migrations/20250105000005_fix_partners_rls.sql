-- Fix RLS policies for partners table to resolve 406 error
-- This migration corrects the conflicting policies that prevent partners from accessing their data
...
USING (
  CASE 
    -- Partners can access their own data via partner_id in profiles
    WHEN EXISTS (
